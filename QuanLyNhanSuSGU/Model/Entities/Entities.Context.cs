...
namespace Model.Entities
{
    ...
    public partial class QuanLyNhanSuSGUEntities : DbContext
    {
        public QuanLyNhanSuSGUEntities()
            : base("name=QuanLyNhanSuSGUEntities")
        {
        }
        ...
        public virtual DbSet<BangCapVienChuc> BangCapVienChucs { get; set; }
